...
export const createApiThunk = (name, endpoint, options = {}) => {
  const {
    ...
    isPrismaEndpoint = false, // Add this flag for Prisma endpoints
  } = options;
...
export const createGenericSlice = (name, apiThunk, initialState = {}) => {
  ...
  const slice = createSlice({
    ...
    reducers: {
      ...
      // Additional reducer for nested data updates
